...
public class LakeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Point adjustedSizeLB = toolBox.adjustAspect(toolBox.POINT_C_LAKE_BLUE_TRASHCAN, currentScreenSize);
        Point adjustedSizeRT = new Point(toolBox.POINT_BACKGROUND.x - (toolBox.POINT_C_LAKE_BLUE_TRASHCAN.x + toolBox.POINT_D_ALL_TRASHCAN.x), toolBox.POINT_BACKGROUND.y - (toolBox.POINT_C_LAKE_BLUE_TRASHCAN.y + toolBox.POINT_D_ALL_TRASHCAN.y));
        ...
        adjustedSizeLB = toolBox.adjustAspect(toolBox.POINT_C_LAKE_GREEN_TRASHCAN, currentScreenSize);
        adjustedSizeRT = new Point(toolBox.POINT_BACKGROUND.x - (toolBox.POINT_C_LAKE_GREEN_TRASHCAN.x + toolBox.POINT_D_ALL_TRASHCAN.x), toolBox.POINT_BACKGROUND.y - (toolBox.POINT_C_LAKE_GREEN_TRASHCAN.y + toolBox.POINT_D_ALL_TRASHCAN.y));
        ...
        params = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        adjustedSizeLB = toolBox.adjustAspect(toolBox.POINT_C_LAKE_YELLOW_TRASHCAN, currentScreenSize);
        adjustedSizeRT = new Point(toolBox.POINT_BACKGROUND.x - (toolBox.POINT_C_LAKE_YELLOW_TRASHCAN.x + toolBox.POINT_D_ALL_TRASHCAN.x), toolBox.POINT_BACKGROUND.y - (toolBox.POINT_C_LAKE_YELLOW_TRASHCAN.y + toolBox.POINT_D_ALL_TRASHCAN.y));
        adjustedSizeWH = toolBox.adjustAspect(toolBox.POINT_D_ALL_TRASHCAN, currentScreenSize);
        adjustedSizeRT = toolBox.adjustAspect(adjustedSizeRT, currentScreenSize);
        params.setMargins(adjustedSizeLB.x, adjustedSizeRT.y, adjustedSizeRT.x, adjustedSizeLB.y);
        params.width = adjustedSizeWH.x;
        ...
        params = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        adjustedSizeLB = toolBox.adjustAspect(toolBox.POINT_C_LAKE_GRAY_TRASHCAN, currentScreenSize);
        adjustedSizeRT = new Point(toolBox.POINT_BACKGROUND.x - (toolBox.POINT_C_LAKE_GRAY_TRASHCAN.x + toolBox.POINT_D_ALL_TRASHCAN.x), toolBox.POINT_BACKGROUND.y - (toolBox.POINT_C_LAKE_GRAY_TRASHCAN.y + toolBox.POINT_D_ALL_TRASHCAN.y));
        adjustedSizeWH = toolBox.adjustAspect(toolBox.POINT_D_ALL_TRASHCAN, currentScreenSize);
        adjustedSizeRT = toolBox.adjustAspect(adjustedSizeRT, currentScreenSize);
        params.setMargins(adjustedSizeLB.x, adjustedSizeRT.y, adjustedSizeRT.x, adjustedSizeLB.y);
        params.width = adjustedSizeWH.x;
        ...
        params = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        adjustedSizeLB = toolBox.adjustAspect(toolBox.POINT_C_LAKE_RED_TRASHCAN, currentScreenSize);
        adjustedSizeRT = new Point(toolBox.POINT_BACKGROUND.x - (toolBox.POINT_C_LAKE_RED_TRASHCAN.x + toolBox.POINT_D_ALL_TRASHCAN.x), toolBox.POINT_BACKGROUND.y - (toolBox.POINT_C_LAKE_RED_TRASHCAN.y + toolBox.POINT_D_ALL_TRASHCAN.y));
        adjustedSizeWH = toolBox.adjustAspect(toolBox.POINT_D_ALL_TRASHCAN, currentScreenSize);
        adjustedSizeRT = toolBox.adjustAspect(adjustedSizeRT, currentScreenSize);
        params.setMargins(adjustedSizeLB.x, adjustedSizeRT.y, adjustedSizeRT.x, adjustedSizeLB.y);
        params.width = adjustedSizeWH.x;
        ...
        params = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        adjustedSizeLB = toolBox.adjustAspect(toolBox.POINT_C_LAKE_BLACK_TRASHCAN, currentScreenSize);
        adjustedSizeRT = new Point(toolBox.POINT_BACKGROUND.x - (toolBox.POINT_C_LAKE_BLACK_TRASHCAN.x + toolBox.POINT_D_ALL_TRASHCAN.x), toolBox.POINT_BACKGROUND.y - (toolBox.POINT_C_LAKE_BLACK_TRASHCAN.y + toolBox.POINT_D_ALL_TRASHCAN.y));
        adjustedSizeWH = toolBox.adjustAspect(toolBox.POINT_D_ALL_TRASHCAN, currentScreenSize);
        adjustedSizeRT = toolBox.adjustAspect(adjustedSizeRT, currentScreenSize);
        params.setMargins(adjustedSizeLB.x, adjustedSizeRT.y, adjustedSizeRT.x, adjustedSizeLB.y);
        params.width = adjustedSizeWH.x;
